...
## Corpus Check
- 49 files · ~93,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1193 nodes · 2460 edges · 67 communities (58 shown, 7 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ebe18d0b`
...
### Community 7 - "auth"
Cohesion: 0.10
Nodes (59): api_helius_webhook_sample(), auth(), can_retry_execution(), create_execution_order(), demo_can_retry(), demo_cannot_retry_risk(), demo_concurrent_idempotency(), demo_controlled_retry() (+51 more)
...
Cohesion: 0.13
Nodes (27): _decode_helius_sync_addresses(), _encoded_helius_sync_addresses(), get_helius_webhook_sync_state(), get_helius_webhook_sync_status(), helius_webhook_sync_worker(), Reconcile tracked tokens without taking ownership of base addresses., sync_helius_webhook_tokens_once(), _tracked_tokens_snapshot() (+19 more)
...
### Community 31 - "db"
Cohesion: 0.07
Nodes (48): api_helius_webhook_stats(), calculate_copyability_score(), cleanup_finished_outcome_token(), complete_finished_signal_outcomes(), create_execution_order_idempotent(), db(), establish_market_event_inbox_activation(), expire_old_signal_outcomes() (+40 more)
...
### Community 43 - "api_watched_wallets"
Cohesion: 0.29
...
### Community 53 - "Scoring dinámico de traders apagado — 2026-09-11"
Cohesion: 0.50
...
Cohesion: 0.06
Nodes (46): claim_market_event_inbox_processing_batch(), consume_market_event_inbox_once(), decide_live_position_exit(), demo(), evaluate_live_position_exit(), finish_market_event_inbox_processing(), helius_webhook(), is_pumpportal_error_message() (+38 more)

### Community 65 - "RpcFallbackPersistenceTests"
Cohesion: 0.17
...
Cohesion: 0.25
Nodes (8): claim_market_event_inbox_validation_batch(), finish_market_event_inbox_validation(), market_event_inbox_validation_worker(), Valida un lote del inbox sin llamar al router ni aplicar efectos., Valida continuamente el inbox; nunca enruta eventos., Reserva eventos observados para validarlos sin ejecutar sus efectos. La reserva…, Finaliza una reserva solo si todavía pertenece al mismo worker., validate_market_event_inbox_once()
