...
## Corpus Check
- 39 files · ~47,503 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 511 nodes · 1226 edges · 32 communities (24 shown, 6 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `723bbc2e`
...
### Community 1 - "db"
Cohesion: 0.05
Nodes (62): build_model_features(), calculate_copyability_score(), cleanup_finished_outcome_token(), complete_finished_signal_outcomes(), create_execution_order_idempotent(), create_signal_outcome(), db(), decide_live_position_exit() (+54 more)
...
### Community 4 - "get_trader_quality_assessment"
Cohesion: 0.40
...
### Community 7 - "app.py"
Cohesion: 0.07
Nodes (107): api_live_execution_readiness(), api_live_positions(), api_shadow_predictions(), api_shadow_stats(), api_training_checkpoint_freshness(), api_training_dataset(), api_training_dataset_preview(), api_training_expired_preview() (+99 more)
...
Cohesion: 0.06
Nodes (5): EvaluationIdempotencyTests, ExecutionAdapterTests, LiveTradingGuardTests, NumericRiskValidationTests, PositionConcurrencyTests
