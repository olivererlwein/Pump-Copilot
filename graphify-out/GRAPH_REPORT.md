...
## Corpus Check
- 45 files · ~81,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 987 nodes · 2060 edges · 57 communities (47 shown, 8 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a301310b`
...
Cohesion: 0.16
Nodes (24): can_retry_execution(), check_execution_timeout(), create_execution_order(), demo_can_retry(), demo_cannot_retry_risk(), demo_controlled_retry(), demo_execution_timeout(), demo_idempotency_failed() (+16 more)
...
### Community 25 - "auth"
Cohesion: 0.09
Nodes (56): api_helius_webhook_sample(), api_helius_webhook_stats(), auth(), demo(), demo_close_old(), demo_concurrent_idempotency(), demo_daily_pnl(), demo_duplicate_check() (+48 more)
...
### Community 28 - "evaluate_buy"
Cohesion: 0.10
Nodes (25): decide_live_position_exit(), decision_from_score(), evaluate_buy(), evaluate_live_position_exit(), helius_webhook(), market_event_block_ts(), market_event_from_inbox_row(), market_event_identity() (+17 more)
...
### Community 34 - "db"
Cohesion: 0.06
Nodes (54): api_live_positions(), cleanup_finished_outcome_token(), complete_finished_signal_outcomes(), count_open_positions(), create_signal_outcome(), db(), demo_daily_pnl_isolation(), demo_mode_isolation() (+46 more)
...
### Community 43 - "app.py"
Cohesion: 0.08
Nodes (51): api_live_execution_readiness(), api_shadow_predictions(), api_shadow_stats(), api_training_checkpoint_freshness(), api_training_expired_preview(), api_training_stats(), api_training_stats_by_trader(), assess_live_model_approval() (+43 more)
...
Cohesion: 0.09
Nodes (23): Correcciones tras la revisión de Codex, Cuarta revisión: el helper no rechazaba lo que decía rechazar, Dos pruebas más, por el router (pedido de Codex), El problema, Límites, Punto 2: identidad completa en las salidas live, Punto 3: protección contra eventos anteriores a la entrada, Qué se hizo (+15 more)
...
### Community 53 - "get_training_dataset_rows"
Cohesion: 0.33
...
Cohesion: 0.33
Nodes (6): migrate_database(), migrate_inbox_event_index_to_ordinal(), migrate_shadow_predictions_for_multiple_models(), migrate_token_history_identity(), Le da identidad a las filas de historial anteriores a `event_id`. Sin esto,…, Renumera el inbox de índice de log a ordinal de operación. Las filas guardadas…
...
## Knowledge Gaps
- **151 isolated node(s):** `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed`, `Step 2 - Detect files` (+146 more)
