...
## Corpus Check
- 61 files · ~112,196 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1482 nodes · 3067 edges · 74 communities (59 shown, 13 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 100 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3cb8819b`
...
Cohesion: 0.06
Nodes (28): account_checkpoint_target(), build_pumpportal_exact_sell_payload(), build_pumpportal_lightning_sell_payload(), calculate_wallet_sell_percentage(), fetch_finalized_solana_transaction(), fetch_solana_signature_status(), normalize_solana_signature(), prepare_pumpportal_lightning_sell() (+20 more)
...
### Community 7 - "auth"
Cohesion: 0.08
Nodes (57): api_account_checkpoint_training_stats(), api_account_price_checkpoint_stats(), api_helius_standard_wss_stats(), api_helius_webhook_sample(), api_helius_webhook_stats(), api_live_execution_readiness(), api_live_positions(), api_shadow_predictions() (+49 more)
...
### Community 28 - "db"
Cohesion: 0.06
Nodes (47): apply_cached_signal_outcome_checkpoints(), calculate_copyability_score(), db(), establish_market_event_inbox_activation(), get_consensus_trader_count(), get_consensus_trader_count_window(), get_daily_live_realized_pnl_sol(), get_execution_latency() (+39 more)
...
### Community 34 - "app.py"
Cohesion: 0.07
Nodes (48): account_checkpoint_training_alert_state_key(), api_account_checkpoint_training_dataset(), api_rpc_fallback_stats(), api_training_checkpoint_freshness(), api_training_dataset(), api_training_dataset_preview(), api_training_expired_preview(), api_training_stats() (+40 more)
...
### Community 59 - "RpcFallbackPersistenceTests"
Cohesion: 0.11
...
Cohesion: 0.14
Nodes (16): apply_paper_event(), count_open_positions(), decide_paper_position_action(), demo_exit_open(), demo_live_position(), demo_partial_open(), get_daily_realized_pnl(), open_paper_position() (+8 more)

### Community 62 - "execute_pumpportal_lightning_buy"
Cohesion: 0.22
Nodes (14): assess_shadow_challenger(), compare_shadow_models(), execute_pumpportal_lightning_buy(), execute_pumpportal_lightning_sell(), get_daily_live_buy_exposure(), get_execution_order_status(), get_live_canary_blockers(), get_live_execution_readiness() (+6 more)
...
Cohesion: 0.08
Nodes (40): claim_market_event_inbox_processing_batch(), consume_market_event_inbox_once(), decide_live_position_exit(), demo(), evaluate_live_position_exit(), finish_market_event_inbox_processing(), helius_webhook(), is_pumpportal_error_message() (+32 more)
...
Cohesion: 0.06
Nodes (39): check_watched_wallet_silence(), claim_market_event_inbox_validation_batch(), cleanup_finished_outcome_token(), complete_finished_signal_outcomes(), expire_old_signal_outcomes(), fetch_solana_balance_sol(), finish_market_event_inbox_validation(), get_ambiguous_pumpportal_execution_orders() (+31 more)
